...
public class XListView extends ListView implements OnScrollListener {
	...
	private int mHeaderViewHeight = 100; // header view's height 初始高度（临时的） 之后会变化
	...
	public final static int ACTION_LOADMORE = 2;
	...
	private void initWithContext(Context context) {
		mHeaderViewHeight = DimensionUtils.dip2px(context, 60);
	...
	/**
	 * reset header view's height at startRefrash.
	 */
	private void resetStartHeaderHeight() {
		int height = mHeaderView.getVisiableHeight();
		// refreshing and header isn't shown fully. do nothing.
		int finalHeight = 0; // default: scroll back to dismiss header.
		// is refreshing, just scroll back to show all the header.
